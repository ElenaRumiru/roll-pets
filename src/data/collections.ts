...
const EASY: CollectionDef[] = [
    ...
    },
    {
        ...
        petIds: ['sheep', 'goat', 'cow', 'pig', 'duck', 'turkey', 'hare', 'beagle', 'ram'],
        difficulty: 'easy', reward: { coins: 500 },
    },
    {
        id: 'forest', nameKey: 'col_forest', icon: 'col_forest_pets',
        petIds: ['squirrel', 'badger', 'mole', 'raccoon', 'owl', 'bear', 'wolf', 'moose', 'beaver', 'porcupine', 'opossum', 'bat'],
        difficulty: 'easy', reward: { coins: 1_000 },
    },
    {
        id: 'birds', nameKey: 'col_birds', icon: 'col_birds_pets',
        petIds: ['pigeon', 'duck', 'turkey', 'owl', 'heron', 'kiwi', 'swan', 'pelican', 'toucan', 'falcon', 'raven', 'hummingbird', 'penguin'],
        difficulty: 'easy', reward: { coins: 1_500 },
    },
    {
        id: 'bugs', nameKey: 'col_bugs', icon: 'col_bugs_pets',
        petIds: ['bee', 'ladybug', 'grasshopper', 'spider', 'scorpion'],
        difficulty: 'easy', reward: { coins: 500 },
    },
    {
        id: 'scaled', nameKey: 'col_scaled', icon: 'col_squama_pets',
        petIds: ['turtle', 'snake', 'chameleon', 'crocodile', 'cobra', 'axolotl'],
        difficulty: 'easy', reward: { coins: 1_000 },
    },
    {
        id: 'rodents', nameKey: 'col_rodents', icon: 'col_rodents_pets',
        petIds: ['mouse', 'hamster', 'squirrel', 'beaver', 'capybara', 'porcupine'],
        difficulty: 'easy', reward: { coins: 500 },
    },
    {
        id: 'river_pond', nameKey: 'col_river_pond', icon: 'col_lake_river_pets',
        petIds: ['frog', 'beaver', 'otter', 'axolotl', 'duck', 'hippo', 'crocodile', 'swan'],
        difficulty: 'easy', reward: { coins: 1_000 },
    },
    {
        id: 'exotic', nameKey: 'col_exotic', icon: 'col_exotic_pets',
        petIds: ['axolotl', 'chameleon', 'capybara', 'red_panda', 'pallas_cat', 'fennec_fox', 'koala', 'kangaroo'],
        difficulty: 'easy', reward: { coins: 1_000 },
    },
    {
...
const MEDIUM: CollectionDef[] = [
    {
        ...
        petIds: ['seahorse', 'dolphin', 'octopus', 'pufferfish', 'shark', 'whale', 'jellyfish', 'squid', 'anglerfish', 'seal'],
        difficulty: 'medium', reward: { coins: 5_000 },
    },
    {
        id: 'savanna', nameKey: 'col_savanna', icon: 'col_savanne_pets',
        petIds: ['giraffe', 'zebra', 'lion', 'cheetah', 'hyena', 'hippo', 'rhino', 'gorilla', 'meerkat'],
        difficulty: 'medium', reward: { coins: 5_000 },
    },
    {
        id: 'arctic', nameKey: 'col_arctic', icon: 'col_arctik_pets',
        petIds: ['penguin', 'seal', 'walrus', 'snowman', 'yeti', 'mammoth'],
        difficulty: 'medium', reward: { coins: 5_000 },
    },
    {
        id: 'felines', nameKey: 'col_felines', icon: 'col_cats_pets_feline',
        petIds: ['cat', 'pallas_cat', 'cheetah', 'jaguar', 'lion', 'cheshire_cat', 'sabertooth'],
        difficulty: 'medium', reward: { coins: 8_000 },
    },
    {
        id: 'canine_pack', nameKey: 'col_canine_pack', icon: 'col_dogs_pets_canids',
        petIds: ['beagle', 'shiba', 'wolf', 'hyena', 'fennec_fox', 'cerberus'],
        difficulty: 'medium', reward: { coins: 8_000 },
    },
    {
    ...
    },
    {
        ...
        petIds: ['hippo', 'rhino', 'gorilla', 'bear', 'whale', 'mammoth', 'golem', 'walrus'],
        difficulty: 'medium', reward: { coins: 8_000 },
    },
    {
        id: 'asian', nameKey: 'col_asian', icon: 'col_asia_pets',
        petIds: ['panda', 'red_panda', 'kitsune', 'shiba', 'chinese_dragon', 'pallas_cat'],
