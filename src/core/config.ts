...
export const QUEST_CONFIG = {
    ...
    onlineSteps: [
        ...
        { target: 2, freeCount: 5,  adCount: 10, buffType: 'epic' as const },
        { target: 3, freeCount: 8,  adCount: 16, buffType: 'epic' as const },
        { target: 4, freeCount: 10, adCount: 20, buffType: 'epic' as const },
        { target: 5, freeCount: 15, adCount: 30, buffType: 'epic' as const },
    ],
